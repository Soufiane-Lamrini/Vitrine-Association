        ...
        <div className="relative z-10 py-12 px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
              ...
              <div className="flex justify-center space-x-4">
                {[
                  ...
                  { name: "Facebook", href: "https://facebook.com/AssociationNourEnfance", color: "hover:text-blue-500" },
                  { name: "Instagram", href: "#", color: "hover:text-pink-400" },
                  { name: "TikTok", href: "#", color: "hover:text-purple-400" }
                ].map(({ name, href, color }, index) => (
                  <a
                    key={index}
                    href={href}
                    target="_blank"
            ...
            <div className="border-t border-white/10 pt-8">
              ...
              <address className="text-slate-400 mt-2 not-italic">
